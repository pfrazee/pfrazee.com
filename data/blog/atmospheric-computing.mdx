...
tags: ['atproto', 'bsky']
draft: false
summary: Cloud computing has been extremely successful, but it lost the values that drove personal computing. We can solve this by evolving forward.
images: ['/static/images/atmospheric-computing/card.png']
---
